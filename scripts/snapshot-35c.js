...
const label=process.argv[2]||'before';fs.writeFileSync(`docs/phase35c/integrity-${label}.json`,JSON.stringify(output,null,2));console.log('Protected environments read-only snapshot saved: '+label);
