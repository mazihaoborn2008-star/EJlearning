...
for(const [name,id,base] of [
 ...
 ['ej-learning-phase3','36c72b9b-da1f-425c-9b1a-6603b0f7d150','https://ej-learning-phase3.yanjian-language-learning.workers.dev'],['ej-learning-35a','c5476d39-27ab-4899-b212-671e893971ee','https://ej-learning-35a.yanjian-language-learning.workers.dev'],['ej-learning-35b','97d676a7-e4c7-4d9e-a863-17f096f5cb9c','https://ej-learning-35b.yanjian-language-learning.workers.dev']]){
...
const label=process.argv[2]||'before';fs.writeFileSync(`docs/phase35b1/integrity-${label}.json`,JSON.stringify(output,null,2));console.log('Protected environments read-only snapshot saved: '+label);
