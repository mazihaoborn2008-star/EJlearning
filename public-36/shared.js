...
export const posNames={verb:'动词',noun:'名词',adverb:'副词',adjective:'形容词','adjectival noun':'な形容词','verb phrase':'动词短语','phrasal verb':'短语动词','prepositional phrase':'介词短语','noun phrase':'名词短语','fixed expression':'固定表达','proper noun':'专有名词',counter:'量词',interjection:'感叹词','adjective phrase':'形容词短语',auxiliary:'助动词',conjunction:'连词',determiner:'限定词',numeral:'数词',preposition:'介词',pronoun:'代词',affix:'接辞',particle:'助词'};
export const posTaxonomy={
 en:[['noun','名词'],['verb','动词'],['adjective','形容词'],['adverb','副词'],['pronoun','代词'],['preposition','介词'],['conjunction','连词'],['determiner','限定词'],['numeral','数词'],['auxiliary','助动词'],['noun phrase','名词短语'],['verb phrase','动词短语'],['phrasal verb','短语动词'],['adjective phrase','形容词短语'],['prepositional phrase','介词短语'],['fixed expression','固定表达'],['proper noun','专有名词'],['interjection','感叹词']],
 ja:[['noun','名詞'],['verb','動詞'],['adjective','い形容詞'],['adjectival noun','な形容詞'],['adverb','副詞'],['pronoun','代名詞'],['particle','助詞'],['conjunction','接続詞'],['auxiliary','助動詞'],['numeral','数詞'],['counter','助数詞'],['affix','接辞'],['noun phrase','名詞句'],['verb phrase','動詞句'],['fixed expression','定型表現'],['proper noun','固有名詞'],['interjection','感動詞']]
};
